import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v1_field-ops_weekly-sales-report.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v1/field-ops/weekly-sales-report';
