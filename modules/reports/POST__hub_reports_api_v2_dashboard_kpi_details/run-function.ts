import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v2_dashboard_kpi_details.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v2/dashboard/kpi/details';
