import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v1_customer-metrics-report.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v1/customer-metrics-report';
