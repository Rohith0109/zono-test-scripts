import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v1_field-ops_monthly-sales-report.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v1/field-ops/monthly-sales-report';
