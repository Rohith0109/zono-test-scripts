import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v2_customer-performance-report.json';
...
export async function run(context: {
  ...
  let path = '/hub/reports/api/v2/customer-performance-report';
