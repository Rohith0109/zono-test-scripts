import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v2_campaign_revenue-report.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v2/campaign/revenue-report';
