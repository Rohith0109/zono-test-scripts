import endpointMeta from '../../../metadata/reports/POST__hub_reports_api_v2_ledger-summary-report.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/reports/api/v2/ledger-summary-report';
