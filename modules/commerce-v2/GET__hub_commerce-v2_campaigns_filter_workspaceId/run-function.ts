import endpointMeta from '../../../metadata/commerce-v2/GET__hub_commerce-v2_campaigns_filter_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/campaigns/filter/{workspaceId}';
