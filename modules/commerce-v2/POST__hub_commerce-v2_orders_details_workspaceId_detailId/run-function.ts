import endpointMeta from '../../../metadata/commerce-v2/POST__hub_commerce-v2_orders_details_workspaceId_detailId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/orders/details/{workspaceId}/{detailId}';
