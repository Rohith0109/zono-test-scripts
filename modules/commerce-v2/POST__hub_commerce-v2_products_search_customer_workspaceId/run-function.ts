import endpointMeta from '../../../metadata/commerce-v2/POST__hub_commerce-v2_products_search_customer_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/products/search/customer/{workspaceId}';
