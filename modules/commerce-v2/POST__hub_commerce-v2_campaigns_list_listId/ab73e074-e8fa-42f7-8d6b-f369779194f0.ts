...
export const metadata = {
  "testCaseId": "ab73e074-e8fa-42f7-8d6b-f369779194f0",
  "method": "POST",
  "endpoint": "POST /hub/commerce-v2/campaigns/list/{listId}",
  "workspaceId": "be436b63-64ba-4f94-bfcf-3e3e0bc4e375",
  "apiDomain": "https://api-qa.zotok.ai",
  "module": "commerce-v2",
  "query": "?pageNo=1&pageSize=10&startDate=2026-03-18+00%3A00%3A00&endDate=2026-04-17+23%3A59%3A59&sellerWorkspaceId=be436b63-64ba-4f94-bfcf-3e3e0bc4e375&random=0.19287481727073708",
  "headers": {
