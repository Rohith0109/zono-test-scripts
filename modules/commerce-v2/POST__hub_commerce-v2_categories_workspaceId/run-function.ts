import endpointMeta from '../../../metadata/commerce-v2/POST__hub_commerce-v2_categories_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/categories/{workspaceId}';
