import endpointMeta from '../../../metadata/commerce-v2/GET__hub_commerce-v2_scheme_workspaceId_schemeId.json';
...
export async function run(context: {
  ...
  for (const ws of targets) {
    let path = '/hub/commerce-v2/scheme/{workspaceId}/{schemeId}';
