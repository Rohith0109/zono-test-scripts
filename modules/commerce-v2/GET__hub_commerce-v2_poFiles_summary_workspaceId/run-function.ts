import endpointMeta from '../../../metadata/commerce-v2/GET__hub_commerce-v2_poFiles_summary_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/poFiles/summary/{workspaceId}';
