import endpointMeta from '../../../metadata/commerce-v2/POST__hub_commerce-v2_category_modify-assignment-to-products_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/commerce-v2/category/modify-assignment-to-products/{workspaceId}';
