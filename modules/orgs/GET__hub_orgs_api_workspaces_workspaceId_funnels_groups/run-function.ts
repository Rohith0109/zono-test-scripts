import endpointMeta from '../../../metadata/orgs/GET__hub_orgs_api_workspaces_workspaceId_funnels_groups.json';
...
export async function run(context: {
  ...
  for (const ws of targets) {
    let path = '/hub/orgs/api/workspaces/{workspaceId}/funnels/groups';
