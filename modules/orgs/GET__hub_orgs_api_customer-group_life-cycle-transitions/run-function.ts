import endpointMeta from '../../../metadata/orgs/GET__hub_orgs_api_customer-group_life-cycle-transitions.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/orgs/api/customer-group/life-cycle-transitions';
