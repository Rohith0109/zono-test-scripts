import endpointMeta from '../../../metadata/orgs/POST__hub_orgs_api_docs_zo-file_list_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/orgs/api/docs/zo-file/list/{workspaceId}';
