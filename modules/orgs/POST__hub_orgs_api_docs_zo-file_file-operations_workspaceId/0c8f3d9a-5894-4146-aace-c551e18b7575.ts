import endpointMeta from '../../../metadata/orgs/POST__hub_orgs_api_docs_zo-file_file-operations_workspaceId.json';
...
export async function run(context: {
  ...
  let path = '/hub/orgs/api/docs/zo-file/file-operations/{workspaceId}';
