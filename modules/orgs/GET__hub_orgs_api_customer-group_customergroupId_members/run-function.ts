import endpointMeta from '../../../metadata/orgs/GET__hub_orgs_api_customer-group_customergroupId_members.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/orgs/api/customer-group/{customergroupId}/members';
