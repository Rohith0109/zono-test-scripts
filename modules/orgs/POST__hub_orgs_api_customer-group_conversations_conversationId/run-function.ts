import endpointMeta from '../../../metadata/orgs/POST__hub_orgs_api_customer-group_conversations_conversationId.json';
...
export async function run(context: {
  ...
  for (const ws of targets) {
    let path = '/hub/orgs/api/customer-group/conversations/{conversationId}';
