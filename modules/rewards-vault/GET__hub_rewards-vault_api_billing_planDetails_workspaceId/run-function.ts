import endpointMeta from '../../../metadata/rewards-vault/GET__hub_rewards-vault_api_billing_planDetails_workspaceId.json';
...
export async function run(context: {
  ...
  for (const ws of targets) {
    let path = '/hub/rewards-vault/api/billing/planDetails/{workspaceId}';
