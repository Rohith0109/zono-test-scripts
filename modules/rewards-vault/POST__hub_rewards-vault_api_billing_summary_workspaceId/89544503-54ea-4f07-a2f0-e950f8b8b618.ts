import endpointMeta from '../../../metadata/rewards-vault/POST__hub_rewards-vault_api_billing_summary_workspaceId.json';
...
export async function run(context: {
  ...
  let path = '/hub/rewards-vault/api/billing/summary/{workspaceId}';
