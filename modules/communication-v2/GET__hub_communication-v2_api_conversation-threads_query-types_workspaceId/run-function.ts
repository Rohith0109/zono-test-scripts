import endpointMeta from '../../../metadata/communication-v2/GET__hub_communication-v2_api_conversation-threads_query-types_workspaceId.json';
...
export async function run(context: {
  ...
  for (const ws of targets) {
    let path = '/hub/communication-v2/api/conversation-threads/query-types/{workspaceId}';
