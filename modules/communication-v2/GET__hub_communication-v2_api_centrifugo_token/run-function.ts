import endpointMeta from '../../../metadata/communication-v2/GET__hub_communication-v2_api_centrifugo_token.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/communication-v2/api/centrifugo/token';
