import endpointMeta from '../../../metadata/communication-v2/POST__hub_communication-v2_api_threads_list_workspaceId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/communication-v2/api/threads/list/{workspaceId}';
