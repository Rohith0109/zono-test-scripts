import endpointMeta from '../../../metadata/communication-v2/GET__hub_communication-v2_api_conversations_internal-notes_internalnoteId.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/hub/communication-v2/api/conversations/internal-notes/{internalnoteId}';
