import endpointMeta from '../../../metadata/partyaccountbook/GET__invoiceservice_partyAccountBook_balanceBySeller.json';
...
export async function run(context: {
  ...
  let resolvedPath = '/invoiceservice/partyAccountBook/balanceBySeller';
